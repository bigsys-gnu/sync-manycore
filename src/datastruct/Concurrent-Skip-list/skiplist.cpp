...
void show_usage()
{
  ...
  cout << "-i <max_number>         Numbers from 1 to max_number are inserted into skip list, subset is chosen for get, "
          "delete, and range \n";
  ...
  cout << "\n[ Kindly use less input values since the output is displayed on console. Higher values provide an "
          "unreadable display ]\n";
