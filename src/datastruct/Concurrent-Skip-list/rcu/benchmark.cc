...
{
  cout << "Usage: \n\n";
  cout << "./benchmark [--name] -i <max_number> -t <num_threads> --benchmark=<insert, delete, search, range, "
          "all_operations, high_contention, low_contention> [--help] \n";
  cout << "--name                         Prints full name \n";
  cout << "-i <max_number>                Numbers from 0 to max_number are inserted into skip list, subset is chosen "
          "for get, delete, and range \n";
...
int main(int argc, char *argv[])
{
  ...
  static struct option long_options[] = {{"name", no_argument, NULL, 'n'},
